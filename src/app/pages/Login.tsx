  ...
  return (
    <div className={`h-full relative flex flex-col ${className}`}>
      ...
      <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center px-8">
        ...
        <div className="w-full max-w-[320px] space-y-3">
          ...
          <div className="flex gap-2">
            <input type="tel" maxLength={6} pattern="[0-9]*" inputMode="numeric" placeholder={t('login.enterCode')} value={code}
              ...
              className="flex-1 bg-[#F5F5F5] dark:bg-gray-800 rounded-xl h-[50px] px-3 text-[15px] text-center tracking-[8px] font-bold dark:text-gray-100 outline-none" />
            <button onClick={handleSendCode} disabled={countdown > 0 || loading || !phone}
              className="h-[50px] px-5 bg-[#FF8C42] rounded-xl text-white text-[14px] font-bold active:bg-[#E67A35] transition-colors disabled:opacity-50 shrink-0">
        ...
        <p className="mt-12 text-center text-[11px] text-[#BBB] dark:text-gray-500">
