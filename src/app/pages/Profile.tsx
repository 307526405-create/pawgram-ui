  ...
  if (!loggedIn) return (
    <div className="h-full bg-white dark:bg-gray-900 flex flex-col items-center justify-center px-8">
      ...
      <div className="w-full max-w-[320px] space-y-3">
        ...
        <button onClick={() => navigate('/login')} className="w-full h-[50px] bg-[#FF8C42] text-white rounded-xl text-[16px] font-bold active:bg-[#E67A35] shadow-md flex items-center justify-center gap-2">
